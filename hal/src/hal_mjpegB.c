...
//	MJPEG_ITEM_SIZE = 32768;
	...
	*/
	    if(mjpegBEncCtrl.ybuffer && mjpegBEncCtrl.mjpbuf)
		   return 0;
		mjpegBEncCtrl.mjpbuf = (INT32U)hal_sysMemMalloc(HAL_CFG_MJPEGB_BUFFER_SIZE,64);//mjbbuf;
		if(mjpegBEncCtrl.mjpbuf==0)
			return -1;
		mjpegBEncCtrl.mjpsize = HAL_CFG_MJPEGB_BUFFER_SIZE;//sizeof(mjbbuf);	
...
* Return         : None
*******************************************************************************/
int mjpB_actech_as_photo(u16 win_w, u16 win_h, u8 quality)
{	
