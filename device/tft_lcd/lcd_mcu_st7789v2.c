...
BEGIN_INIT_TAB
	...
	CMD(0xC3),	   
	DAT(0x11),	 //GVDD=4.8V			 //0x15
	
	CMD(0xC4),	   
	DAT(0x20),	 //VDV, 0x20:0v
...
LCD_OP_SECTION lcddev_t st7789v2 = 
{
    .name = "st7789v2",
    ...
    .pclk_div = PLL_CLK/(240*240*2*60)/2,
    .even_order = 0,
    .odd_order = 0,
