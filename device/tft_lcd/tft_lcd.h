...
#define DEV_LCD_ST7789V2 22 // ok 240*240
#define DEV_LCD_GC9307 23   // ok 240*240

#define DEV_LCD DEV_LCD_GC9307 // DEV_LCD_ST7282// DEV_LCD_ST7789V2 //DEV_LCD_ST7282//
