...
void sensor_rotato(u8 para)
{
	if(NULL != devSensorOp->p_fun_adapt.fp_rotate)
	{
		if(para)
			para = 0;
		else
		...
		hal_csiEnable(0);
		debg("set rotate success : [%d]\n",para);
		devSensorOp->p_fun_adapt.fp_rotate(para);
