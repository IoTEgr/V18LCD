...
void menuProcDelCur2(winHandle handle,uint32 parameNum,uint32* parame);
void menuProcDelAll(winHandle handle,uint32 parameNum,uint32* parame);
void menuProcDelAll2(winHandle handle,uint32 parameNum,uint32* parame);
...
MENU_ITME_START(playBack2)
MENU_ITEM_PROC(menuProcDelCur2,R_ID_ICON_MENUDELONE,R_ID_STR_SET_DELETE)
MENU_ITEM_PROC(menuProcDelAll2,R_ID_ICON_MENUDELALL,R_ID_STR_SET_DELETEALL)
//MENU_ITEM_PROC(menuProcLockCur,R_ID_ICON_MENUUNLOCK,R_ID_STR_SET_LOCKCUR)
//MENU_ITEM_PROC(menuProcUnlockCur,R_ID_ICON_MENUUNLOCK,R_ID_STR_SET_UNLOCKCUR)
//MENU_ITEM_PROC(menuProcUnlockAll,R_ID_ICON_MENUUNLOCK,R_ID_STR_SET_UNLOCKALL)
MENU_ITME_END()
...
MENU_PAGE_START(playBack2)
MENU_PAGE_ITEMS(playBack2,R_ID_ICON_MTMENU,R_ID_ICON_MTMENU,R_ID_STR_SET_VIDEO)
MENU_PAGE_END()
