...
#if(AUDIO_REC_EN==1)
#define  MANAGER_LIST_NUM     2    // at least,support 3-list
#else
#define  MANAGER_LIST_NUM     1    // at least,support 3-list
#endif
#define  MANAGER_NODE_NUM     5

#define  MANAGER_LIST_MAX     1024 // max file number
...
#define  MA_FILE_LOKA   0x10000000
#define  MA_FILE_LOKB   0x20000000
#define  MA_FILE_LOK    0x30000000
#define  MA_FILE_BSY    0x40000000
#define  MA_FILE_IVL    0x80000000
