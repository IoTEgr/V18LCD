...
static int delAllKeyMsgpPower(winHandle handle,uint32 parameNum,uint32* parame)
{
	...
	return delAllKeyMsgOk(handle, parameNum, parame);
...
msgDealInfor delAllMsgDeal[]=
{
	...
	{KEY_EVENT_POWER,delAllKeyMsgpPower},
