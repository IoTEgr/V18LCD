...
static int menuUsbKeyMsgPower(winHandle handle,uint32 parameNum,uint32* parame)
{
	...
	return menuUsbKeyMsgOk(handle, parameNum, parame);
}
...
msgDealInfor menuUsbMsgDeal[]=
{
	...
	{KEY_EVENT_POWER,menuUsbKeyMsgPower},
