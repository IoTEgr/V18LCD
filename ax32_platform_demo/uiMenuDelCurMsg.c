...
static int delCurKeyMsgPower(winHandle handle,uint32 parameNum,uint32* parame)
{
	...
	return delCurKeyMsgOk(handle, parameNum, parame);
}
...
msgDealInfor delCurMsgDeal[]=
{
	...
	{KEY_EVENT_POWER,delCurKeyMsgPower},
