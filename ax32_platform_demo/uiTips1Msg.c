...
static int tips1KeyMsgPower(winHandle handle,uint32 parameNum,uint32* parame)
{
	return tips1KeyMsgOk(handle, parameNum, parame);
}
...
msgDealInfor tips1MsgDeal[]=
{
	...
	{KEY_EVENT_MODE,tips1KeyMsgPower},
