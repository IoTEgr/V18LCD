...
s32_t userConfigReset(void)
{
	...
	configSet(CONFIG_ID_YEAR,             2022);
	configSet(CONFIG_ID_MONTH,            4);
	configSet(CONFIG_ID_MDAY,             6);
	configSet(CONFIG_ID_WDAY,             3);
	...
	configSet(CONFIG_ID_AUTOOFF,          R_ID_STR_TIM_3MIN/*R_ID_STR_COM_OFF*/);
#if HAL_CFG_LCD_CROP
    configSet(CONFIG_ID_SCREENSAVE,       R_ID_STR_COM_OFF);
#else
	configSet(CONFIG_ID_SCREENSAVE,       R_ID_STR_TIM_2MIN/*R_ID_STR_COM_OFF*/);
#endif
	...
	configSet(CONFIG_ID_RESOLUTION,       R_ID_STR_RES_FHD/*R_ID_STR_RES_HD*/);
	...
	configSet(CONFIG_ID_LOOPTIME,         R_ID_STR_TIM_5MIN);
