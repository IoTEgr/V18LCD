...
MENU_OPTION_STR(R_ID_STR_TIM_15MIN)
MENU_OPTION_END()
...
MENU_OPTION_START(sensor)//--------sensor
MENU_OPTION_STR(R_ID_STR_COM_OFF)
MENU_OPTION_STR(R_ID_STR_COM_ON)
MENU_OPTION_END()
...
MENU_OPTION_STR(R_ID_STR_LAN_KOREA)
...
MENU_OPTION_STR(R_ID_STR_COM_OFF)
MENU_OPTION_STR(R_ID_STR_TIM_30SEC)
MENU_OPTION_STR(R_ID_STR_TIM_2MIN)
MENU_OPTION_STR(R_ID_STR_TIM_3MIN)
//MENU_OPTION_STR(R_ID_STR_TIM_5MIN)
//MENU_OPTION_STR(R_ID_STR_TIM_10MIN)
...
MENU_ITEM_OPTIONS(sensor,CONFIG_ID_SENSOR,R_ID_ICON_MENUTV,R_ID_STR_SET_SENSOR)
...
MENU_ITEM_OPTIONS(keySound,CONFIG_ID_KEYSOUND,R_ID_ICON_MENUVOLUME,R_ID_STR_SET_BEEPSOUND)
