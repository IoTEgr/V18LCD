...
static void updata_settings_write_param(void)
{
	...
	if ((settings_buf[5] != ':') || (settings_buf[15] != ':') || (settings_buf[22] != ':') || (settings_buf[33] != ':'))
	{
	...
	if ((strncmp(buf1, "1080P", sizeof("1080P")) != 0) || (strncmp(buf2, "RECYCLE", sizeof("RECYCLE")) != 0) || (strncmp(buf3, "TIME", sizeof("TIME")) != 0) || (strncmp(buf4, "FILETIME", sizeof("FILETIME")) != 0))
	{
		updata_settings_set_default_param();
		f_unlink(UPDATE_SETTING_FILE);
		updata_settings_txt_default();
