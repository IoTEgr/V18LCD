...
{
	//PRELOAD_ICON(R_ID_ICON_CLOCKRECT),
    PRELOAD_ICON(R_ID_ICON_CLOCKRECT1),

	//PRELOAD_ICON(R_ID_ICON_MTBATTERY5),
    PRELOAD_ICON(R_ID_ICON_DATE_B0),
    PRELOAD_ICON(R_ID_ICON_DATE_B1),
    PRELOAD_ICON(R_ID_ICON_DATE_B2),
    PRELOAD_ICON(R_ID_ICON_DATE_B3),
    PRELOAD_ICON(R_ID_ICON_DATE_B4),
    PRELOAD_ICON(R_ID_ICON_DATE_B5),
    PRELOAD_ICON(R_ID_ICON_DATE_B6),
    PRELOAD_ICON(R_ID_ICON_DATE_B7),
    PRELOAD_ICON(R_ID_ICON_DATE_B8),
    PRELOAD_ICON(R_ID_ICON_DATE_B9),

	PRELOAD_ICON(R_ID_ICON_CLOCKPOWEROFFC),
    PRELOAD_ICON(R_ID_ICON_CLOCKPOWEROFFE),
