...
void ax32xx_mjpeg_manual_stop(void)
{
	...
	PRE_JPINTCON &= ~BIT(11); 		//MJP_INIT_EN
	PRE_JPCON1 |= BIT(9); 			//JESTOP
	
	//mdf 2017/7/6
	//CSI_DMA_MODE &= ~BIT(31); 	//_CSI_MJP_OFF
	PRE_JPFLG_CLR = -1;				//MJP_INT_PENDING	
...
void ax32xx_mpegPrint(void)
{
	deg_Printf("R_MJPEG_OUT_SADDR = %x\n",R_MJPEG_OUT_SADDR);
	deg_Printf("R_MJPEG_OUT_EADDR = %x\n",R_MJPEG_OUT_EADDR);
	deg_Printf("R_MJPEG_IN_SADDR = %x\n",R_MJPEG_IN_SADDR);
	deg_Printf("R_MJPEG_IN_EADDR = %x\n",R_MJPEG_IN_EADDR);	
	deg_Printf("R_MJPEG_INTEN = %x\n",R_MJPEG_INTEN);
	deg_Printf("R_MJPEG_CTRL1 = %x\n",R_MJPEG_CTRL1);
	deg_Printf("R_MJPEG_INTCLR = %x\n",R_MJPEG_INTCLR);
	deg_Printf("R_MJPEG_INTSTATUS = %x\n",R_MJPEG_INTSTATUS);
	deg_Printf("R_MJPEG_SIZE = %x\n",R_MJPEG_SIZE);
	deg_Printf("R_MJPEG_SIZE1 = %x\n",R_MJPEG_SIZE1);
	deg_Printf("R_MJPEG_XSCALER = %x\n",R_MJPEG_XSCALER);
	deg_Printf("R_MJPEG_YSCALER = %x\n",R_MJPEG_YSCALER);
	deg_Printf("R_MJPEG_HEIGHT = %x\n",R_MJPEG_HEIGHT);
	deg_Printf("R_MJPEG_BIT = %x\n",R_MJPEG_BIT);
	deg_Printf("R_MJPEG_OUTPTR = %x\n",R_MJPEG_OUTPTR);
	deg_Printf("R_MJPEG_OUTLOAD = %x\n",R_MJPEG_OUTLOAD);
	deg_Printf("R_MJPEG_INPTR = %x\n",R_MJPEG_INPTR);
	deg_Printf("R_MJPEG_DRI = %x\n",R_MJPEG_DRI);

	deg_Printf("R_MJPEG_LINES = %x\n",R_MJPEG_LINES);
	deg_Printf("R_MJPEG_DADDR = %x\n",R_MJPEG_DADDR);
	deg_Printf("R_MJPEG_DTATS = %x\n",R_MJPEG_DTATS);
	deg_Printf("R_MJPEG_TABLE = %x\n",R_MJPEG_TABLE);

	deg_Printf("R_MJPEG_CCOEF0 = %x\n",R_MJPEG_CCOEF0);
	deg_Printf("R_MJPEG_CCOEF1 = %x\n",R_MJPEG_CCOEF1);
	deg_Printf("R_MJPEG_CCOEF2 = %x\n",R_MJPEG_CCOEF2);
	deg_Printf("R_MJPEG_CCOEF3 = %x\n",R_MJPEG_CCOEF3);
	deg_Printf("R_MJPEG_CCOEF4 = %x\n",R_MJPEG_CCOEF4);
	deg_Printf("R_MJPEG_CCOEF5 = %x\n",R_MJPEG_CCOEF5);
	deg_Printf("R_MJPEG_CCOEF6 = %x\n",R_MJPEG_CCOEF6);
	deg_Printf("R_MJPEG_CCOEF7 = %x\n",R_MJPEG_CCOEF7);
...
void ax32xx_mjpB_stop(void)
{
	...
	//mdf 2017/7/6
	//CSI_DMA_MODE &= ~BIT(31); 	//_CSI_MJP_OFF
	BACK_JPFLG_CLR = -1;				//MJP_INT_PENDING	
	ax32xx_intEnable(IRQ_JPGB,0);		
	//debg("\nstop\n");
	//debg("j:%x",BACK_JPFLG);	
}
...
* Return         : None
*******************************************************************************/
INT32S jpeg1_decode_check(void)
{
