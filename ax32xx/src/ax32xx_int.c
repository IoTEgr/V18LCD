...
void fast_isr(void)
{
    ...
    {
    case IRQ_CSI:
        ax32xx_csiIRQHandler();
        break;
    case IRQ_AUADC:
        ax32xx_auadcIRQHandler();
        break;
    case IRQ_JPGB:
        ax32xx_mjpegBIRQHandler();
        break;
    case IRQ_UART0:
        ax32xx_uart0IRQHandler();
        break;
    case IRQ_LCDC:
    ...
    case IRQ_DE:
        ...
        break;
    case IRQ_EMI:
        ax32xx_emiIRQHandler();
        break;
    case IRQ_DAC:
        ax32xx_dacIRQHandler();
        break;
    case IRQ_TIMER0:
        ax32xx_timer0IRQHandler();
        break;
    case IRQ_TIMER1:
        ax32xx_timer1IRQHandler();
        break;
    case IRQ_TIMER2:
        ax32xx_timer2IRQHandler();
        break;
    case IRQ_TIMER3:
        ax32xx_timer3IRQHandler();
        break;
    case IRQ_GPIO:
        ax32xx_gpioIRQHandler();
        break;
    case IRQ_USB20:
        (*fp_usb_isr)();
        break;
    case IRQ_RTC_WDT:
        ax32xx_rtcIRQHandler();
        break;
    case IRQ_USB11:
        (*fp_usb11_isr)();
        break;
...
void slow_isr(void)
{
    ...
    case IRQ_EMI:
        ...
        break;
    case IRQ_ROTATE:
        ax32xx_rotateIRQHandler();
        break;
    case IRQ_OSDCMP:
        ax32xx_osdcmpIRQHandler();
        break;
    case IRQ_USB11:
        (*fp_usb11_isr)();
        break;
